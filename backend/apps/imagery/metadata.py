...
def parse_source_name(path_or_name: str | Path) -> ParsedFilename:
...
def parse_product_group(group: ProductGroup) -> dict:
    parsed = parse_source_name(group.stem)
    values = {
    ...
    if group.files.get("stac.json"):
        ...
        values.update({
            ...
            "polarizations": _polarizations(polar_raw) or values["polarizations"],
        ...
        values["acquisition_time"] = center_time or values["acquisition_time"] or receive_time
