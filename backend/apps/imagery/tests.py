...
class ImageryApiTests(ImageryApiTestBase):
    ...
    def test_owner_can_edit_archive_find_and_restore_imagery(self):
        ...
        self.assertEqual(stac["properties"]["sathub:display_name"], "Hefei scene")
        self.assertEqual(stac["properties"]["sathub:project_ids"], [str(self.project.pk)])
        ...
        self.assertTrue(archived_stac["properties"]["sathub:is_archived"])
